...
/client/proc/InitClient()
	...
	//Proxima. Lore summary
	to_chat(src, "<br><span class='info'><strong>Введение в лор:</span></strong><br><br> Идёт 25 век общечеловеческой эры. Само человечество уже давно покинуло свою колыбельную в Солнечной системе и начало своё распространение по рукаву Ориона, попутно встречая иные разумные формы жизни. Далёкие колонии со временем отсоединялись от своих метрополий, образовывая новые государства, не без участия крови и стали. Со временем между странами стала вырисовываться новая сила - корпорации. Не раз они схватывались с различными государствами за власть и деньги, но мир держался в относительном балансе, и не кому не удавалось перевесить чашу весов в свою сторону. Всё изменилось в 2417 году, когда одна из корпораций - НаноТрейзен, обнаружила форон.<br><br> Форон, обладающий невероятными физическими свойствами, дал человечеству не бывалый толчок в развитии. Конечно же, он сразу озолотил НаноТрейзен, сделав её самой богатой и влиятельной корпорацией. Видя это, Альянс Солнечной Системы - одно из самых антикорпоративных государств, решил захватить у НаноТрейзен все источники форона, пока для него не стало слишком поздно. Вмешательство Альянса сделало невозможное - богатейшие корпорации, ведомые страхом, что за НаноТрейзен последуют и они, объединились в Межзвёздный Конгломерат Корпораций - МКК. Под руководством НаноТрейзен, МКК дало отпор Альянсу, ввергнув тот в эпоху раздора и гражданских войн, после чего по сути Конгломерат стал доминирующей силой в галактике.<br><br> Идёт 2464 год. Многие государства, такие как Республика Бизель, кредит которой является доминирующей валютой в мире, де-факто полностью управляются корпорациями.И хоть лидером МКК является Миранда Трейзен, остальные корпорации внутри него всё ещё готовы побороться за власть между собой и не являются полными марионетками НТ. Но никто не празднует вечно. Месторождения форона, вокруг которого уже начала крутиться вся экономика галактики и особенно самих корпораций, начинают истощаться. Со всей возможной скоростью МКК создаёт 'Горизонт' - невероятно технологичный, способный на дальние полёты и экспедиции корабль. Его миссия - любой ценой найти новые месторождения форона, да бы спасти экономику человечества и мир корпораций. А это значит, что это и Ваша цель, ведь именно Вы составляете экипаж корабля Горизонт.<br><br>Гонка началась.<br>")
